...
- Active WU-014 delivery: PRs #134/#135/#136/#138/#140/#142/#144/#146/#148/#150 are merged on `main`; team privacy PR #150 final head `51791feb2047c69b108b143e51742d863dcd9960` passed API Validation run `35673947070`, Web Validation run `35673947111` and AI Native Quality Gates run `35673947096` before squash merge `4b0fedcb72386404b72403208afdca7284cac611`. Issue #151 is the active narrow team-member status lifecycle slice.
...
- Issue #151 / PR #152: ordinary team-member status lifecycle is the active WU-014 slice — candidate API requires active same-tenant `team.manage`, targets only opaque membership IDs, prohibits self-mutation, allows only `active ↔ suspended`, restricts eligible targets to the ordinary `member` role with baseline non-management permissions, never changes roles/permissions, and reuses the shared fail-closed PostgreSQL runtime. Initial head `43bab4c1f6079dcac63b7cfe0274f70247658203` passed dependency audit/pin checks but API Validation run `35767976469` stopped at TypeScript because one invalid-route test loop inferred tuple entries as possibly undefined; the test fixture is now explicitly typed and exact-head API + AI-Native reverification is required before merge.
