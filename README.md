...
- Active WU-014 delivery: PRs #134/#135/#136/#138/#140/#142/#144/#146/#148/#150/#152/#154 are merged on `main`; browser team-status PR #154 exact head `5b01b1ea692cb5a08cd8ef555d2d84a2540cb355` passed Web Validation run `35768752575` and AI Native Quality Gates run `35768752606` before squash merge `e26802cfd2b58125bbf788479de71a21798adda9`. Issue #155 is the active browser-identity privacy hardening slice removing trusted subject identifiers from workspace bootstrap.
...
- Issue #155: browser workspace bootstrap identity privacy hardening is the active WU-014 slice — trusted `subject_id` remains inside server authorization/membership resolution only, browser authorization summaries expose organization/membership/roles/permissions, strict schemas/clients reject subject/session fields, and tenant authorization semantics remain unchanged; exact-head API + Web + AI-Native verification is required before merge.
