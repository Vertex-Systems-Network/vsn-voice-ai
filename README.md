...
- Active WU-014 delivery: PRs #134/#135/#136/#138/#140/#142/#144/#146/#148/#150/#152 are merged on `main`; team-status API PR #152 final head `dfc524bfc8b4501f168a723d2c92430417b491a8` passed API Validation run `35768085893` and AI Native Quality Gates run `35768085746` before squash merge `7f4a65c701ce10b56e68113ac0c157ed10f3526c`. Issue #153 is the active browser team-status controls slice.
...
- Issue #153: browser ordinary-member status controls are the active WU-014 slice — Team read remains independent, management controls are gated by selected-workspace bootstrap `team.manage`, mutation sends only `{status}`, validates exact tenant+membership response binding, hides controls from non-managers, and fences late old-tenant responses; exact-head Web + AI-Native verification is required before merge.
